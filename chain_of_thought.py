...
class CoTAgent:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        # Use provided agent_name or default
        final_agent_name = agent_name or "cot-agent"
        final_description = description
        
        self.agent_name = final_agent_name
        ...
        if agent is not None:
            ...
            # Prepare agent kwargs, ensuring agent_name and agent_description are set
            agent_kwargs = {
            ...
            if final_description is not None:
                agent_kwargs["agent_description"] = final_description
    ...
    def run(
        ...
        **kwargs,
        ...
        Args:
            ...
            *args: Additional positional arguments (passed to internal agent if needed)
            **kwargs: Additional keyword arguments (passed to internal agent if needed)
    ...
    def step(self, task: str, *args, **kwargs) -> str:
        """
        Execute a single step of the CoT reasoning process.
        ...
        return result if isinstance(result, str) else result.final_answer
    
    def __getattr__(self, name: str):
        """
        Delegate attribute access to the internal agent for methods not explicitly defined.
        This allows CoTAgent to work like other agents in swarms.
        """
